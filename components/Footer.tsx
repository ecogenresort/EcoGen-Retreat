        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="flex items-center">
            <video 
              ...
              muted
              playsInline
              className="h-20 w-36 sm:h-24 sm:w-44 md:h-32 md:w-64 object-cover rounded-3xl border border-white/25 shadow-lg"
            >
              <source 
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <ul className="space-y-5 text-sm">
            ...
            <li className="flex items-center gap-3">
              ...
              <a href="mailto:ecogen999@gmail.com" className="opacity-80 hover:text-gold transition">ecogen999@gmail.com</a>
            </li>
          </ul>
        </div>
